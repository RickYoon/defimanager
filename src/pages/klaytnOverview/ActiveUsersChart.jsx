                ...
                {isloading ? 
                    ...
                    <defs>
                      <linearGradient id="color2" x1="0" y1="0" x2="0" y2="1">
                          <stop offset="0%" stopColor="#dd4477" stopOpacity={0.4} />
                          <stop offset="75%" stopColor="#dd4477" stopOpacity={0.05} />
                      </linearGradient>
                    </defs>

                    <Bar dataKey="vale" stroke="#dd4477" fill="url(#color2)" />
...
function Chartrange (props) {
    ...
    return (
        ...
        <Styled.Rangedisplay>Monthly Active Users </Styled.Rangedisplay>
        }
