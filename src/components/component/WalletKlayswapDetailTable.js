...
const WalletKlayswapDetailTable = () => {
    ...
    return (
        ...
        <SubTemplateBlockVertical style={{marginTop:"20px"}}>
                <div style={{ fontSize: "18px", color: "#657795" }}>Klayswap Total
                {isLoading ?
                    <><span><ReactLoading type="spin" color="black" height={24} width={24} /></span> </> :
                    <span style={{ fontSize: "24px" }}> : $ {assetState.klayswap.klayswapTotalBalance.toFixed(2)}</span>
                }
                </div>
                ...
                <Table>
                    ...
                    {assetState.klayswap.SinglePoolList.map((singlePool)=>
                        ...
                        <Tr>
                            <Td>Singlepool</Td>
                            <Td>{singlePool.tokenName}</Td>
                            <Tdr>-</Tdr>
                            <Tdr></Tdr>
                            <Tdr>{singlePool.value.toFixed(2)}</Tdr>
                        </Tr>
                        </tbody>
                    ...
                    <Tr>
                        <Td>Pairpool</Td>
                        <Td>{pairPool.tokenAname}-{pairPool.tokenBname}</Td>
                        <Tdr>{pairPool.tokenAnumber.toFixed(2)} {pairPool.tokenAname}</Tdr>
                        <Tdr>{pairPool.tokenBnumber.toFixed(2)} {pairPool.tokenBname}</Tdr>
                        <Tdr>{pairPool.value.toFixed(2)}</Tdr>
                    </Tr>
                    </tbody>
...
export default WalletKlayswapDetailTable;