...
const WalletKlayswapDetail = () => {
    ...
    return (
        ...
        <SubTemplateBlockVertical>
            ...
            <div style={{ marginBottom: "10px", fontSize: "20px" }}>Governance Token</div>
                <Innercontainer>
                    <InnerBox>
                        ...
                        <Value>
                            $ {assetState.klayswap.stakingKSP}
                        </Value>
                        <div style={{fontSize:"13px", color:"gray", marginTop:"10px"}}> token price : {4.22}$</div>
                ...
                {/* {assetState.klayswap.tokenList.map((token) => (
                    <InnerBox>
            ...
            <MobileTemplate>
            <div style={{ marginBottom: "10px", fontSize: "20px" }}>PairPool</div>
                <Innercontainer>
